...
export const dict = {
  ...
  "prompt.action.voiceCancel": "Cancel transcription",
  "prompt.toast.voiceUnavailable.title": "Voice input unavailable",
  "prompt.toast.voiceUnavailable.description": "Your browser does not support audio recording.",
  "prompt.toast.voiceUnsupportedFormat.description": "This browser does not support the available audio formats.",
  "prompt.toast.voiceMicBlocked.title": "Microphone blocked",
  "prompt.toast.voiceMicBlocked.description": "Allow microphone access to start recording.",
  "prompt.toast.voiceEmpty.title": "No speech detected",
  "prompt.toast.voiceEmpty.description": "Try recording again.",
  "prompt.toast.voiceFailed.title": "Transcription failed",
  "prompt.toast.voiceFailed.description": "Try recording again.",
  "prompt.toast.voiceCancelled.title": "Transcription cancelled",
  "prompt.toast.voiceCancelled.description": "Stopped the current transcription.",
