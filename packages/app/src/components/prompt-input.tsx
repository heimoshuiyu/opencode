      ...
      <Show when={store.mode === "normal" || store.mode === "shell"}>
        <DockTray attach="top">
          <div class="overflow-x-auto no-scrollbar">
            <div class="px-1.75 pt-5.5 pb-2 flex items-center gap-2 min-w-full w-max">
              <div class="flex items-center gap-1.5 min-w-0 flex-1 relative">
                ...
                <div class="flex items-center gap-1.5 min-w-0 flex-1">
                  <div data-component="prompt-agent-control" class="min-w-0 shrink">
                    <TooltipKeybind
                      placement="top"
                      gutter={4}
                    ...
                    >
                      <Select
                        ...
                        class="capitalize min-w-0 max-w-[120px] sm:max-w-[160px] text-text-base"
                  ...
                  <div data-component="prompt-model-control" class="min-w-0 shrink">
                    <Show
                  ...
                  <div data-component="prompt-variant-control" class="min-w-0 shrink">
                    <TooltipKeybind
                      placement="top"
                      gutter={4}
